 ...
 *
 * Description: if the file isn't a ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_data - print the content of the ELF header.
 * @e_ident: Pointer to an array of the ELF class.
 */
void print_data(unsigned char *e_ident)
{
 ...
 * @e_ident: Pointer the array that contain the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * print_type - Display the type of ELF header.
 * @e_type:  ELF type.
 * @e_ident: pointer to array that contain the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * print_entry - print point of entry of an ELF header.
 * @e_entry: Address of the ELF point of entry.
 * @e_ident: Pointer to array that contain the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
 * main - print the informations contained in the
 *        ELF header at the beginning of the ELF file.
 * @argc: Numbers of arguments to be supplied to the program.
